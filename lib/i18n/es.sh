...
Este programa convierte tu Ubuntu en una experiencia tipo macOS:
  ...
  • Búsqueda instantánea con Cmd+Espacio
...
¿Desactivar el inicio de sesión automático para arreglarlo? (Escribirás tu contraseña al encender, como en un Mac)"
  ...
  [m15_wifi_dkms]="WiFi: dejando el driver listo para futuras actualizaciones del sistema…"
  [m15_ul]="Instalando Ulauncher (el motor de la búsqueda ⌘Espacio)…"
  [m15_ul_err]="No se pudo instalar Ulauncher; la búsqueda ⌘Espacio queda pendiente"
  ...
  [mod_47]="Batería y suspensión para laptops mayores"
  [m47_ok]="Batería y suspensión ajustadas para laptops mayores (pantalla se apaga a los 5 min, suspende con batería a los 15, ahorro al quedar poca; todo cambiable en Configuración)"
  [mod_50]="Búsqueda instantánea (Cmd+Espacio)"
  ...
  [m75_dry]="HARÍA: instalar el latido semanal de novedades (avisos de versión + UNA invitación de apoyo a los 30 días; se apaga en la app Second Wind, menú ⋯)"
  [m75_ok]="Latido de novedades armado: avisos de versión y UNA invitación de apoyo a los 30 días. Apágalo cuando quieras en la app Second Wind (menú ⋯)"
  [mod_80]="Actualizaciones automáticas (con vuelta atrás de seguridad)"
  [m80_dry]="HARÍA: armar el chequeo semanal de actualizaciones (un aviso, una contraseña, y vuelta atrás automática si algo empeora)"
  [m80_ok]="Actualizaciones armadas: un chequeo silencioso 5 minutos después de encender y luego cada semana; tú decides cuándo aplicar"
  [mod_85]="Silenciar avisos de primer arranque"
  [m85_dry]="HARÍA: ocultar los avisos de primer arranque de Ubuntu (el asistente de configuración y la ventana del actualizador de software)"
  [m85_ok]="Avisos de primer arranque de Ubuntu silenciados (asistente, actualizador). Las actualizaciones siguen funcionando"
  [gui_ok]="Encender mi Mac"
  [gui_cancel]="Ahora no"
  [gui_consent]="Esto convierte tu Ubuntu en un Mac: el look completo, atajos de teclado Mac, búsqueda instantánea con ⌘Espacio y arreglos de MacBook (cámara, ventilador, teclas F y la pantalla de inicio Mac).\n\nPrimero se guarda un RESPALDO COMPLETO de tu configuración, y todo se puede deshacer después.\n\nTarda unos 10 a 15 minutos (un poco más en los Mac más antiguos) y se reinicia una vez al final. Puedes dejar el Mac solo mientras tanto, conectado al cargador. ¿Empezamos?"
  [gui_phase_prep]="Preparando…"
  [gui_step]="Paso %s de %s: %s"
  [gui_left]="faltan unos %s min"
  [gui_almost]="casi listo"
  [gui_progress_title]="Second Wind · no apagues el Mac"
  [gui_err_title]="Second Wind"
  [gui_err_body]="Algo interrumpió la preparación. No se perdió nada: se retoma donde quedó la próxima vez que inicies sesión."
  [gui_err_log]="Registro técnico:"
...
¿Cerrar sesión ahora? (Guarda antes tu trabajo abierto)"
  ...
  [m50_no_ul]="Ulauncher no está instalado; la búsqueda ⌘Espacio queda pendiente (la Etapa 1 lo instalará automáticamente)."
  [m50_dry]="HARÍA: instalar el tema estilo Mac para Ulauncher, dejarlo en autoarranque y asignar Cmd+Espacio"
  [m50_done]="Búsqueda lista: pulsa Cmd+Espacio para buscar."
...
¿Cierro Firefox ahora?"
  ...
  [m70_msg]="Apps estilo Mac: abre 'Second Wind' desde el dock"
  [m70_dry]="HARÍA: instalar la app 'Second Wind' (icono en el dock: apps con casillas, actualizaciones, ayuda y Mac Experience)"
  [m70_installed]="'Second Wind' quedó en el dock: ábrelo para añadir Spotify, Office y más con casillas, buscar actualizaciones o pedir ayuda"
  [store_name]="Second Wind"
...
¿Continuar?"
  ...
  [v_sleep_bat]="Con batería: suspende tras 15 min inactiva"
  [v_sleep_ac]="Enchufada: nunca se auto-suspende"
  [v_screen_off]="La pantalla se apaga tras 5 min inactiva"
  [v_lock_wake]="Pide la clave al despertar"
  [v_toshy]="Servicio de teclado Mac (Toshy) activo"
  [v_tray]="Icono de Toshy oculto"
  [v_ul_run]="Ulauncher (búsqueda ⌘Espacio) en ejecución"
  [v_spot_key]="Atajo Cmd+Espacio → búsqueda"
  ...
  [v_passed]="correctas,"
  [v_upd]="Chequeo semanal de actualizaciones armado"
  [v_result]="Resultado:"
  ...
  [trial_note]="Mac Experience (teclado ⌘ y búsqueda ⌘Espacio) está ENCENDIDO: gratis por 30 días, luego US\$10 una sola vez desde la tienda de apps. Tu Mac en sí es gratis para siempre."
  [exp_notify_body]="Se cumplieron tus 30 días de Mac Experience. Tu Mac sigue funcionando y viéndose exactamente igual. Solo los atajos ⌘ y la búsqueda ⌘Espacio volvieron al estándar. Recupéralos por US\$10, una vez, tuyos para siempre."
  [exp_notify_buy]="Recuperarlo (US\$10)"
  [exp_notify_later]="Entendido"
  [exp_on_ok]="Mac Experience está ENCENDIDO (teclado ⌘ y búsqueda ⌘Espacio activos)"
