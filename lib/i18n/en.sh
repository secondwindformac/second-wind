...
Continue?"
  ...
  [trial_note]="Mac Experience (⌘ keyboard, Spotlight) is ON: free for 30 days, then US\$10 once from the app store. Your Mac itself stays free forever."
  [exp_notify_body]="Your 30 days of Mac Experience are up. Your Mac keeps working and looking exactly the same. Only the ⌘ shortcuts and Spotlight went back to standard. Bring them back for US\$10, once, yours forever."
  [exp_notify_buy]="Get it back (US\$10)"
  [exp_notify_later]="Got it"
  [exp_on_ok]="Mac Experience is ON (⌘ keyboard + Spotlight active)"
