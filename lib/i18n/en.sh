...
Disable automatic login to fix it? (You will type your password at startup, like on a Mac)"
  ...
  [m15_ul]="Installing Ulauncher (the ⌘Space search engine)…"
  [m15_ul_err]="Could not install Ulauncher; ⌘Space search stays pending"
  ...
  [mod_47]="Battery and sleep for older laptops"
  [m47_ok]="Battery and sleep tuned for older laptops (screen off at 5 min, suspend on battery at 15, saver when low; all changeable in Settings)"
  [mod_50]="Instant search (Cmd+Space)"
  ...
  [mod_75]="Project news (weekly check, easy opt-out)"
  [m75_dry]="WOULD DO: install the weekly news heartbeat (update notices + one 30-day support nudge; opt-out in the Second Wind app, ⋯ menu)"
  [m75_ok]="News heartbeat armed: update notices and ONE support nudge after 30 days. Switch it off anytime in the Second Wind app (⋯ menu)"
  ...
  [gui_ok]="Turn on my Mac"
  [gui_cancel]="Not now"
  [gui_consent]="This turns your Ubuntu into a Mac: the full look, Mac keyboard shortcuts, instant ⌘Space search, and MacBook fixes (camera, fan, F-keys, and the Mac login screen).\n\nA FULL BACKUP of your settings is saved first, and everything can be undone later.\n\nIt takes about 10 to 15 minutes (a bit longer on the oldest Macs) and restarts once at the end. You can leave the Mac alone meanwhile, plugged into its charger. Ready?"
  [gui_phase_prep]="Preparing…"
  [gui_step]="Step %s of %s: %s"
  [gui_left]="about %s min left"
  [gui_almost]="almost done"
  [gui_progress_title]="Second Wind · keep the Mac on"
  [gui_err_title]="Second Wind"
  [gui_err_body]="Something interrupted the setup. Nothing was lost: it picks up where it left off the next time you log in."
...
Log out now? (Save your open work first)"
  ...
  [m50_no_ul]="Ulauncher is not installed; ⌘Space search stays pending (Stage 1 will install it automatically)."
  [m50_dry]="WOULD DO: install the Mac-style theme for Ulauncher, enable autostart and bind Cmd+Space"
  [m50_done]="Search ready: press Cmd+Space to search."
...
Close Firefox now?"
  ...
  [m70_msg]="Mac-style apps: open 'Second Wind' from the dock"
  [m70_dry]="WOULD DO: install the 'Second Wind' app (dock icon: apps with checkboxes, updates, help and Mac Experience)"
  [m70_installed]="'Second Wind' is in the dock: open it to add Spotify, Office and more with checkboxes, check for updates or get help"
...
Continue?"
  ...
  [v_sleep_bat]="On battery: suspends after 15 idle minutes"
  [v_sleep_ac]="Plugged in: never auto-suspends"
  [v_screen_off]="Screen turns off after 5 idle minutes"
  [v_lock_wake]="Asks for the password on wake"
  [v_toshy]="Mac keyboard service (Toshy) active"
  [v_tray]="Toshy icon hidden"
  [v_ul_run]="Ulauncher (⌘Space search) running"
  [v_spot_key]="Cmd+Space → search shortcut"
  ...
  [v_passed]="passed,"
  [v_upd]="Weekly self-update check armed"
  [v_result]="Result:"
  ...
  [m76_dry]="Would set up the 30-day Mac Experience trial clock"
  [m76_ok]="Mac Experience trial armed (30 days, everything on)"
  [trial_note]="Mac Experience (⌘ keyboard and ⌘Space search) is ON: free for 30 days, then US\$10 once from the app store. Your Mac itself stays free forever."
  [exp_notify_body]="Your 30 days of Mac Experience are up. Your Mac keeps working and looking exactly the same. Only the ⌘ shortcuts and ⌘Space search went back to standard. Bring them back for US\$10, once, yours forever."
  [exp_notify_buy]="Get it back (US\$10)"
  [exp_notify_later]="Got it"
  [exp_on_ok]="Mac Experience is ON (⌘ keyboard and ⌘Space search active)"
  [exp_off_ok]="Mac Experience is off. The system, look and your files are untouched"
  [exp_act_ok]="License activated. Welcome back to your Mac ✔"
  [exp_act_prov]="Activated (couldn't reach the license server; accepted provisionally, will re-check quietly)"
  [exp_act_bad]="That key doesn't look valid, is expired, or is already used on another Mac"
  [exp_act_usage]="usage: second-wind-experience activate <license-key>"
  [v_exp]="Mac Experience state matches reality (services + shortcuts)"
)
