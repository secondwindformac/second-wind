...
T = {
    ...
    "exp_off": d("Apagado. Tu Mac sigue igual; recupera los atajos ⌘ y la búsqueda ⌘Espacio por US$10",
                 "Off. Your Mac is unchanged; bring back the ⌘ shortcuts and ⌘Space search for US$10"),
    ...
    "exp_act_okmsg": d("¡Listo! Tus atajos ⌘ y la búsqueda ⌘Espacio están de vuelta.",
                       "Done! Your ⌘ shortcuts and ⌘Space search are back."),
